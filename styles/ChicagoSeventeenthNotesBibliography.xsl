...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt"	xmlns:b="http://schemas.openxmlformats.org/officeDocument/2006/bibliography" xmlns:t="http://www.microsoft.com/temp">
  ...
  <xsl:template name="templ_str_PatentFiledCap" >
    <xsl:param name="LCID" />
    <xsl:text>Patent filed</xsl:text>
  </xsl:template>
  ...
  <xsl:template name="templ_str_EditionShortUnCap" >
    <xsl:param name="LCID" />
    <xsl:text>%1 ed.</xsl:text>
  </xsl:template>

  
  <xsl:template name="templ_str_EditionUnCap" >
    <xsl:param name="LCID" />
    <xsl:text>%1 edition</xsl:text>
  </xsl:template>
  ...
  <xsl:template name="templ_str_FromCap" >
    <xsl:param name="LCID" />
    <xsl:text>Retrieved from %1</xsl:text>
  </xsl:template>
  ...
  <xsl:template name="templ_str_RecordedByCap" >
    <xsl:param name="LCID" />
    <xsl:text>Recorded by %1</xsl:text>
  </xsl:template>
  ...
  <xsl:template match="/">
    ...
    <xsl:choose>
      ...
      <xsl:when test="b:OfficeStyleKey">
        <xsl:text>ChicagoNotesBibliography17</xsl:text>
      </xsl:when>
      ...
      <xsl:when test="b:StyleNameLocalized">
        <xsl:choose>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1033'">
            <xsl:text>Chicago Notes-Bibliography 17th Edition</xsl:text>
          </xsl:when>
          <xsl:otherwise>
            <xsl:text>Chicago Notes-Bibliography 17th Edition</xsl:text>
          </xsl:otherwise>
                                ...
                                <html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word" xmlns="http://www.w3.org/TR/REC-html40">
                                        ...
                                        <body>
                                                ...
                                                <xsl:attribute name="dir">
                                                        ...
                                                        <xsl:variable name="cited" select="msxsl:node-set($ListPopulatedWithMain)/b:Citation/b:Source"/>

                                                        <xsl:variable name="type">
                                                                <xsl:value-of select="$cited/b:SourceType"/>
                                                        </xsl:variable>

                                                        <xsl:variable name="title0">
                                                                <xsl:choose>
                                                                        <xsl:when test="string-length($cited/b:ShortTitle)>0">
                                                                                <xsl:value-of select="$cited/b:ShortTitle"/>
                                                                        </xsl:when>
                                                                        <xsl:otherwise>
                                                                                <xsl:value-of select="$cited/b:Title"/>
                                                                        </xsl:otherwise>
                                                                </xsl:choose>
                                                        </xsl:variable>

                                                        <xsl:variable name="year0">
                                                                <xsl:value-of select="$cited/b:Year"/>
                                                        </xsl:variable>
                                                        ...
                                                        <xsl:variable name="pagesPrefix">
                                                                <xsl:choose>
                                                                        <xsl:when test="not(string-length($pages)=string-length(translate($pages, ',', '')))">
                                                                                <xsl:text>pp.</xsl:text>
                                                                        </xsl:when>
                                                                        <xsl:when test="string-length($pages)=string-length(translate($pages, '-&#8211;&#8212;', ''))">
                                                                                <xsl:text>p.</xsl:text>
                                                                        </xsl:when>
                                                                        <xsl:otherwise>
                                                                                <xsl:text>pp.</xsl:text>
                                                ...
                                                <xsl:variable name="author0">
                                                        <xsl:choose>
                                                                <xsl:when test="string-length($cited/b:Author/b:Main/b:Corporate)>0 and true">
                                                                        <xsl:value-of select="$cited/b:Author/b:Main/b:Corporate"/>
                                                                </xsl:when>
                                                                <xsl:when test="string-length($cited/b:Author/b:Main/b:Corporate)>0">
                                                                        <xsl:value-of select="$cited/b:Author/b:Main/b:Corporate"/>
                                                                </xsl:when>
                                                                <xsl:otherwise>
                                                                        <xsl:variable name="cA" select="count($cited/b:Author/b:Main/b:NameList/b:Person)"/>
                                                                        <xsl:for-each select="$cited/b:Author/b:Main/b:NameList/b:Person">
                                                                                <xsl:choose>
                                                                                        <xsl:when test="$cA > 3">
                                                                                                <xsl:if test="position() = 1">
                                                				<xsl:call-template name="formatNameCore">
                                                				        <xsl:with-param name="FML" select="'%F %L'"/>
                                                				        <xsl:with-param name="FM" select="'%F %L'"/>
                                                				        <xsl:with-param name="ML" select="'%F %L'"/>
                                                				        <xsl:with-param name="FL" select="'%F %L'"/>
                                                				...
                                                				<xsl:call-template name="formatNameCore">
                                                				        ...
                                                				        <xsl:with-param name="withDot">no</xsl:with-param>
                                                                                                ...
                                                                                                <xsl:if test="position() &lt; $cA">
                                                                                                        <xsl:choose>
                                                                                                                <xsl:when test="$cA = 2">
                                                                                                                        <xsl:text> and </xsl:text>
                                                                                                                </xsl:when>
                                                                                                                <xsl:when test="position() = $cA - 1">
                                                                                                                        <xsl:text>, and </xsl:text>
                                                                                                                </xsl:when>
                                                                                                                <xsl:otherwise>
                                                                                                                        <xsl:text>, </xsl:text>
                                                        ...
                                                        <xsl:variable name="pub"><xsl:if test="string-length($cited/b:City)>0"><xsl:value-of select="$cited/b:City"/><xsl:text>: </xsl:text></xsl:if><xsl:if test="string-length($cited/b:Publisher)>0"><xsl:value-of select="$cited/b:Publisher"/><xsl:if test="string-length($year0)>0"><xsl:text>, </xsl:text></xsl:if></xsl:if><xsl:if test="string-length($year0)>0"><xsl:value-of select="$year0"/></xsl:if></xsl:variable>
                                                        <xsl:variable name="note">
                                                          <xsl:choose>
                                                            ...
                                                            <xsl:when test="$type='Book' or $type='Report'">
                                                              ...
                                                              <xsl:call-template name="ApplyItalicTitleNS"><xsl:with-param name="data"><xsl:value-of select="$title"/></xsl:with-param></xsl:call-template>
                                                              <xsl:if test="string-length(normalize-space($pub))>0">
                                                                <xsl:text> (</xsl:text><xsl:value-of select="$pub"/><xsl:text>)</xsl:text>
                                                              </xsl:if>
                                                            </xsl:when>

                                                            <xsl:when test="$type='JournalArticle' or $type='ArticleInAPeriodical'">
                                                              <xsl:if test="string-length($author)>0">
                                                                <xsl:value-of select="$author"/><xsl:text>, </xsl:text>
                                                              </xsl:if>
                                                              <xsl:call-template name="templ_prop_OpenQuote"/><xsl:value-of select="$title"/><xsl:call-template name="templ_prop_CloseQuote"/><xsl:text>, </xsl:text>
                                                              <xsl:if test="string-length($cited/b:JournalName)>0"><xsl:call-template name="ApplyItalicTitleNS"><xsl:with-param name="data"><xsl:value-of select="$cited/b:JournalName"/></xsl:with-param></xsl:call-template></xsl:if>
                                                              <xsl:if test="string-length($cited/b:PeriodicalTitle)>0"><xsl:call-template name="ApplyItalicTitleNS"><xsl:with-param name="data"><xsl:value-of select="$cited/b:PeriodicalTitle"/></xsl:with-param></xsl:call-template></xsl:if>
                                                              <xsl:if test="string-length($cited/b:Volume)>0">
                                                                <xsl:text> </xsl:text><xsl:value-of select="$cited/b:Volume"/>
                                                              </xsl:if>
                                                              <xsl:if test="string-length($cited/b:Issue)>0">
                                                                <xsl:text>, no. </xsl:text><xsl:value-of select="$cited/b:Issue"/>
                                                              </xsl:if>
                                                              <xsl:if test="string-length($year0)>0">
                                                                <xsl:text> (</xsl:text><xsl:value-of select="$year0"/><xsl:text>)</xsl:text>
                                                              </xsl:if>
                                                            </xsl:when>
                                                            ...
                                                            <xsl:when test="$type='BookSection'">
                                                              ...
                                                              <xsl:call-template name="templ_prop_OpenQuote"/><xsl:value-of select="$title"/><xsl:call-template name="templ_prop_CloseQuote"/><xsl:text>, </xsl:text>
                                                              <xsl:if test="string-length($cited/b:BookTitle)>0">
                                                                <xsl:text>in </xsl:text><xsl:call-template name="ApplyItalicTitleNS"><xsl:with-param name="data"><xsl:value-of select="$cited/b:BookTitle"/></xsl:with-param></xsl:call-template>
                                                                <xsl:if test="string-length($cited/b:Author/b:Editor/b:NameList/b:Person[1]/b:Last)>0 or string-length($cited/b:Author/b:Editor/b:Corporate)>0">
                                                                  <xsl:text>, edited by </xsl:text>
                                                                  <xsl:for-each select="$cited/b:Author/b:Editor/b:NameList/b:Person">
                                                                                                                    	<xsl:call-template name="formatNameCore">
                                                	        <xsl:with-param name="FML" select="'%F %L'"/>
                                                	        <xsl:with-param name="FM" select="'%F %L'"/>
                                                	        <xsl:with-param name="ML" select="'%F %L'"/>
                                                	        ...
                                                	        <xsl:with-param name="withDot">no</xsl:with-param>
                                                                    ...
                                                                    <xsl:if test="position() &lt; count(../b:Person)">
                                                                      <xsl:choose>
                                                                        <xsl:when test="count(../b:Person) = 2"><xsl:text> and </xsl:text></xsl:when>
                                                                        <xsl:when test="position() = count(../b:Person) - 1"><xsl:text>, and </xsl:text></xsl:when>
                                                            ...
                                                            <xsl:when test="$type='InternetSite' or $type='DocumentFromInternetSite' or $type='ElectronicSource'">
                                                              <xsl:if test="string-length($author)>0">
                                                                <xsl:value-of select="$author"/><xsl:text>, </xsl:text>
                                                              </xsl:if>
                                                              <xsl:call-template name="templ_prop_OpenQuote"/><xsl:value-of select="$title"/><xsl:call-template name="templ_prop_CloseQuote"/>
                                                              <xsl:if test="string-length($cited/b:InternetSiteTitle)>0">
                                                                <xsl:text>, </xsl:text><xsl:call-template name="ApplyItalicTitleNS"><xsl:with-param name="data"><xsl:value-of select="$cited/b:InternetSiteTitle"/></xsl:with-param></xsl:call-template>
                                                              </xsl:if>
                                                              <xsl:variable name="siteDate">
                                                                <xsl:if test="string-length($cited/b:Month)>0"><xsl:value-of select="$cited/b:Month"/><xsl:text> </xsl:text></xsl:if>
                                                                <xsl:if test="string-length($cited/b:Day)>0"><xsl:value-of select="$cited/b:Day"/><xsl:text>, </xsl:text></xsl:if>
                                                                <xsl:value-of select="$year0"/>
                                                              </xsl:variable>
                                                              <xsl:if test="string-length(normalize-space($siteDate))>0">
                                                                <xsl:text>, </xsl:text><xsl:value-of select="$siteDate"/>
                                                              </xsl:if>
                                                              <xsl:if test="string-length($cited/b:URL)>0">
                                                                <xsl:text>, </xsl:text><xsl:value-of select="$cited/b:URL"/>
                                                              </xsl:if>
                                                            </xsl:when>
                                                            ...
                                                            <xsl:otherwise>
                                                              ...
                                                              <xsl:if test="string-length($title)>0">
                                                                ...
                                                                <xsl:if test="string-length($year0)>0"><xsl:text>, </xsl:text></xsl:if>
                                                              </xsl:if>
                                                              <xsl:if test="string-length($year0)>0">
                                                                <xsl:value-of select="$year0"/>
                                                              </xsl:if>
                                                        ...
                                                        <xsl:apply-templates select="msxsl:node-set($note)" mode="outputHtml"/>
                                                        ...
                                                        <xsl:if test="string-length(normalize-space($note))>0 or string-length($pages)>0">
                                                                <xsl:call-template name="need_Dot">
                                                                        <xsl:with-param name="field">
                                                                                <xsl:value-of select="msxsl:node-set($note)"/><xsl:value-of select="$pages"/>
                                                                        </xsl:with-param>
                                                                </xsl:call-template>
                                                        </xsl:if>
                                                        <xsl:if test="not(msxsl:node-set($ListPopulatedWithMain)/b:Citation/b:LastAuthor)">
                                                                <xsl:text>; </xsl:text>
                                                        </xsl:if>
                                                </xsl:element>
                                        </body>
                  ...
                  <xsl:variable name = "source">
                    <xsl:choose>
                      <xsl:when test="b:SourceType='Book'">
                        <xsl:variable name="sg1">
                          <xsl:if test="string-length(normalize-space($authorDot))>0">
                            <xsl:apply-templates select="msxsl:node-set($authorDot)" mode="outputHtml"/>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg2">
                          <xsl:copy-of select="$sg1"/>
                          <xsl:if test="string-length($title)>0">
                            <xsl:if test="string-length(normalize-space($sg1))>0">
                              <xsl:text> </xsl:text>
                            </xsl:if>
                            <xsl:call-template name="ApplyItalicTitleNS"><xsl:with-param name="data"><xsl:value-of select="$title"/></xsl:with-param></xsl:call-template><xsl:call-template name="need_Dot"><xsl:with-param name="field" select="$title"/></xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg3">
                          <xsl:copy-of select="$sg2"/>
                          <xsl:if test="string-length(b:City)>0 or string-length(b:Publisher)>0 or string-length($year)>0">
                            <xsl:if test="string-length(normalize-space($sg2))>0">
                              <xsl:text> </xsl:text>
                            </xsl:if>
                            <xsl:if test="string-length(b:City)>0"><xsl:value-of select="b:City"/><xsl:text>: </xsl:text></xsl:if><xsl:if test="string-length(b:Publisher)>0"><xsl:value-of select="b:Publisher"/><xsl:if test="string-length($year)>0"><xsl:text>, </xsl:text></xsl:if></xsl:if><xsl:if test="string-length($year)>0"><xsl:value-of select="$year"/></xsl:if>
                          </xsl:if>
                        </xsl:variable>
                        ...
                        <xsl:variable name="sg4">
                          <xsl:copy-of select="$sg3"/>
                          <xsl:if test="string-length(normalize-space($rf))>0">
                            <xsl:if test="string-length(normalize-space($sg3))>0">
                              <xsl:text>. </xsl:text>
                            </xsl:if>
                            <xsl:copy-of select="$rf"/>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg5">
                          <xsl:copy-of select="$sg4"/>
                          <xsl:if test="string-length($doi)>0">
                            <xsl:if test="string-length(normalize-space($sg4))>0">
                              <xsl:text>. </xsl:text>
                            </xsl:if>
                        ...
                        <xsl:variable name="sg6">
                          <xsl:copy-of select="$sg5"/>
                          <xsl:if test="string-length(normalize-space($sg5))>0 and (string-length($doi)=0 and string-length(normalize-space($rf))=0)">
                            <xsl:call-template name="need_Dot">
                              <xsl:with-param name="field"><xsl:value-of select="msxsl:node-set($sg5)"/></xsl:with-param>
                            </xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:apply-templates select="msxsl:node-set($sg6)" mode="outputHtml"/>
                      </xsl:when>
                      <xsl:when test="b:SourceType='BookSection'">
                        ...
                        <xsl:variable name="sg2">
                          ...
                          <xsl:if test="string-length($title)>0">
                            ...
                            <xsl:call-template name="templ_prop_OpenQuote"/><xsl:value-of select="$title"/><xsl:call-template name="templ_prop_CloseQuote"/><xsl:call-template name="need_Dot"><xsl:with-param name="field" select="$title"/></xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg3">
                          <xsl:copy-of select="$sg2"/>
                          <xsl:if test="string-length(b:BookTitle)>0">
                            ...
                            <xsl:text>In </xsl:text><xsl:call-template name="ApplyItalicTitleNS"><xsl:with-param name="data"><xsl:value-of select="b:BookTitle"/></xsl:with-param></xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg4">
                          <xsl:copy-of select="$sg3"/>
                          <xsl:if test="string-length($editorLF)>0">
                            ...
                            <xsl:text>edited by </xsl:text><xsl:call-template name="secBy"><xsl:with-param name="role" select="'Editor'"/></xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg5">
                          <xsl:copy-of select="$sg4"/>
                        ...
                        <xsl:variable name="sg6">
                          <xsl:copy-of select="$sg5"/>
                          <xsl:if test="string-length(b:City)>0 or string-length(b:Publisher)>0 or string-length($year)>0">
                            <xsl:if test="string-length(normalize-space($sg5))>0">
                              <xsl:text>, </xsl:text>
                            </xsl:if>
                            <xsl:if test="string-length(b:City)>0"><xsl:value-of select="b:City"/><xsl:text>: </xsl:text></xsl:if><xsl:if test="string-length(b:Publisher)>0"><xsl:value-of select="b:Publisher"/><xsl:if test="string-length($year)>0"><xsl:text>, </xsl:text></xsl:if></xsl:if><xsl:if test="string-length($year)>0"><xsl:value-of select="$year"/></xsl:if>
                          </xsl:if>
                        ...
                        <xsl:variable name="sg7">
                          <xsl:copy-of select="$sg6"/>
                          <xsl:if test="string-length(normalize-space($rf))>0">
                            <xsl:if test="string-length(normalize-space($sg6))>0">
                              <xsl:text>. </xsl:text>
                            </xsl:if>
                            <xsl:copy-of select="$rf"/>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg8">
                          <xsl:copy-of select="$sg7"/>
                          <xsl:if test="string-length($doi)>0">
                            <xsl:if test="string-length(normalize-space($sg7))>0">
                              <xsl:text>. </xsl:text>
                            </xsl:if>
                            <xsl:value-of select="$doiPrefix"/>
                            <xsl:value-of select="$doi"/>
                        ...
                        <xsl:variable name="sg9">
                          <xsl:copy-of select="$sg8"/>
                          <xsl:if test="string-length(normalize-space($sg8))>0 and (string-length($doi)=0 and string-length(normalize-space($rf))=0)">
                            <xsl:call-template name="need_Dot">
                              <xsl:with-param name="field"><xsl:value-of select="msxsl:node-set($sg8)"/></xsl:with-param>
                            </xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:apply-templates select="msxsl:node-set($sg9)" mode="outputHtml"/>
                      </xsl:when>
                      <xsl:when test="b:SourceType='JournalArticle'">
                        ...
                        <xsl:variable name="sg3">
                          ...
                          <xsl:if test="string-length($journalName)>0">
                            ...
                            <xsl:call-template name="ApplyItalicTitleNS"><xsl:with-param name="data"><xsl:value-of select="$journalName"/></xsl:with-param></xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg4">
                          <xsl:copy-of select="$sg3"/>
                        ...
                        <xsl:variable name="sg9">
                          <xsl:copy-of select="$sg8"/>
                          <xsl:if test="string-length($doi)>0">
                            <xsl:if test="string-length(normalize-space($sg8))>0">
                              <xsl:text>. </xsl:text>
                            </xsl:if>
                            <xsl:value-of select="$doiPrefix"/>
                            <xsl:value-of select="$doi"/>
                        ...
                        <xsl:variable name="sg10">
                          <xsl:copy-of select="$sg9"/>
                          <xsl:if test="string-length(normalize-space($sg9))>0 and (string-length($doi)=0 and string-length(normalize-space($rf))=0)">
                            <xsl:call-template name="need_Dot">
                              <xsl:with-param name="field"><xsl:value-of select="msxsl:node-set($sg9)"/></xsl:with-param>
                            </xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:apply-templates select="msxsl:node-set($sg10)" mode="outputHtml"/>
                      </xsl:when>
                      <xsl:when test="b:SourceType='ArticleInAPeriodical'">
                        ...
                        <xsl:variable name="sg3">
                          ...
                          <xsl:if test="string-length($periodicalTitle)>0">
                            ...
                            <xsl:call-template name="ApplyItalicTitleNS"><xsl:with-param name="data"><xsl:value-of select="$periodicalTitle"/></xsl:with-param></xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg4">
                          <xsl:copy-of select="$sg3"/>
                          <xsl:if test="string-length(b:Year)>0 or string-length(b:Month)>0 or string-length(b:Day)>0">
                            <xsl:if test="string-length(normalize-space($sg3))>0">
                              <xsl:text>, </xsl:text>
                            </xsl:if>
                            <xsl:call-template name="formatDate"/>
                        ...
                        <xsl:variable name="sg8">
                          <xsl:copy-of select="$sg7"/>
                          <xsl:if test="string-length(normalize-space($sg7))>0 and (string-length($doi)=0 and string-length(normalize-space($rf))=0)">
                            <xsl:call-template name="need_Dot">
                              <xsl:with-param name="field"><xsl:value-of select="msxsl:node-set($sg7)"/></xsl:with-param>
                            </xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:apply-templates select="msxsl:node-set($sg8)" mode="outputHtml"/>
                      </xsl:when>
                      <xsl:when test="b:SourceType='ConferenceProceedings'">
                        ...
                        <xsl:variable name="sg3">
                          ...
                          <xsl:if test="string-length(b:ConferenceName)>0">
                            ...
                            <xsl:call-template name="ApplyItalicTitleNS"><xsl:with-param name="data"><xsl:value-of select="b:ConferenceName"/></xsl:with-param></xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg4">
                          <xsl:copy-of select="$sg3"/>
                      ...
                      <xsl:when test="b:SourceType='Report'">
                        ...
                        <xsl:variable name="sg3">
                          <xsl:copy-of select="$sg2"/>
                          <xsl:if test="string-length(b:Institution)>0">
                            <xsl:if test="string-length(normalize-space($sg2))>0">
                              <xsl:text>, </xsl:text>
                            </xsl:if>
                        ...
                        <xsl:variable name="sg7">
                          <xsl:copy-of select="$sg6"/>
                          <xsl:if test="string-length(normalize-space($sg6))>0 and (string-length($doi)=0 and string-length(normalize-space($rf))=0)">
                            <xsl:call-template name="need_Dot">
                              <xsl:with-param name="field"><xsl:value-of select="msxsl:node-set($sg6)"/></xsl:with-param>
                            </xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:apply-templates select="msxsl:node-set($sg7)" mode="outputHtml"/>
                      </xsl:when>
                      <xsl:when test="b:SourceType='SoundRecording'">
                        ...
                        <xsl:variable name="sg2">
                          <xsl:copy-of select="$sg1"/>
                          <xsl:if test="string-length($composer)=0 and string-length($performer)>0">
                            <xsl:if test="string-length(normalize-space($sg1))>0">
                              <xsl:text> </xsl:text>
                            </xsl:if>
                            <xsl:value-of select="$performer"/>
                        ...
                        <xsl:variable name="sg4">
                          ...
                          <xsl:if test="string-length(b:AlbumTitle)>0">
                            ...
                            <xsl:call-template name="ApplyItalicTitleNS"><xsl:with-param name="data"><xsl:value-of select="b:AlbumTitle"/></xsl:with-param></xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg5">
                          <xsl:copy-of select="$sg4"/>
                      ...
                      <xsl:when test="b:SourceType='Performance'">
                        <xsl:variable name="sg1">
                          <xsl:if test="string-length(b:Title)>0">
                            <xsl:call-template name="ApplyItalicTitleNS"><xsl:with-param name="data"><xsl:value-of select="b:Title"/></xsl:with-param></xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg2">
                          <xsl:copy-of select="$sg1"/>
                          <xsl:if test="string-length($writer)>0">
                            <xsl:if test="string-length(normalize-space($sg1))>0">
                              <xsl:text> </xsl:text>
                            </xsl:if>
                            <xsl:text>by </xsl:text><xsl:value-of select="$writer"/>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg3">
                          <xsl:copy-of select="$sg2"/>
                          <xsl:if test="string-length($director)>0">
                            ...
                            <xsl:text>directed by </xsl:text><xsl:value-of select="$director"/>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg4">
                          <xsl:copy-of select="$sg3"/>
                          <xsl:if test="string-length(b:Theater)>0">
                            <xsl:if test="string-length(normalize-space($sg3))>0">
                              <xsl:text>, </xsl:text>
                            </xsl:if>
                      ...
                      <xsl:when test="b:SourceType='Art'">
                        <xsl:variable name="sg1">
                          <xsl:if test="string-length(normalize-space($artistLFDot))>0">
                            <xsl:apply-templates select="msxsl:node-set($artistLFDot)" mode="outputHtml"/>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg2">
                          <xsl:copy-of select="$sg1"/>
                      ...
                      <xsl:when test="b:SourceType='DocumentFromInternetSite'">
                        ...
                        <xsl:variable name="sg3">
                          ...
                          <xsl:if test="string-length(b:InternetSiteTitle)>0">
                            ...
                            <xsl:call-template name="ApplyItalicTitleNS"><xsl:with-param name="data"><xsl:value-of select="b:InternetSiteTitle"/></xsl:with-param></xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="rf">
                          <xsl:if test="string-length($doi)=0">
                      ...
                      <xsl:when test="b:SourceType='Case'">
                        ...
                        <xsl:variable name="sg3">
                          <xsl:copy-of select="$sg2"/>
                          <xsl:if test="string-length(b:Court)>0">
                            <xsl:if test="string-length(normalize-space($sg2))>0">
                              <xsl:text>, </xsl:text>
                            </xsl:if>
                      ...
                      <xsl:when test="b:SourceType='Patent'">
                        <xsl:variable name="sg1">
                          <xsl:if test="string-length(normalize-space($inventorLFDot))>0">
                            <xsl:apply-templates select="msxsl:node-set($inventorLFDot)" mode="outputHtml"/>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg2">
                          <xsl:copy-of select="$sg1"/>
                          <xsl:if test="string-length(b:Title)>0">
                            ...
                            <xsl:call-template name="templ_prop_OpenQuote"/><xsl:value-of select="b:Title"/><xsl:call-template name="need_Dot"><xsl:with-param name="field" select="b:Title"/></xsl:call-template><xsl:call-template name="templ_prop_CloseQuote"/>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg3">
                          <xsl:copy-of select="$sg2"/>
                          <xsl:if test="string-length(b:PatentNumber)>0">
                            ...
                            <xsl:if test="string-length(b:CountryRegion)>0"><xsl:value-of select="b:CountryRegion"/><xsl:text> </xsl:text></xsl:if><xsl:text>patent </xsl:text><xsl:value-of select="b:PatentNumber"/>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg4">
                          <xsl:copy-of select="$sg3"/>
                      ...
                      <xsl:when test="b:SourceType='Misc'">
                        ...
                        <xsl:variable name="sg3">
                          ...
                          <xsl:if test="string-length(b:PublicationTitle)>0">
                            ...
                            <xsl:call-template name="ApplyItalicTitleNS"><xsl:with-param name="data"><xsl:value-of select="b:PublicationTitle"/></xsl:with-param></xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg4">
                          <xsl:copy-of select="$sg3"/>
                      ...
                      <xsl:when test="b:SourceType='Interview'">
                        <xsl:variable name="sg1">
                          <xsl:if test="string-length(normalize-space($intervieweeLFDot))>0">
                            <xsl:apply-templates select="msxsl:node-set($intervieweeLFDot)" mode="outputHtml"/>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg2">
                          <xsl:copy-of select="$sg1"/>
                          <xsl:if test="count(b:Author/b:Interviewer/b:NameList/b:Person)>0">
                            <xsl:if test="string-length(normalize-space($sg1))>0">
                              <xsl:text>, </xsl:text>
                            </xsl:if>
                            <xsl:text>interview by </xsl:text><xsl:call-template name="secBy"><xsl:with-param name="role" select="&quot;Interviewer&quot;"/></xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
                        <xsl:variable name="sg3">
                          <xsl:copy-of select="$sg2"/>
  ...
  <xsl:template name="templateRDAFU">
    <xsl:if test="string-length(b:YearAccessed)>0 or string-length(b:MonthAccessed)>0 or string-length(b:DayAccessed)>0">
      <xsl:text>Accessed </xsl:text><xsl:call-template name="formatDateAccessed"/><xsl:text>. </xsl:text>
    </xsl:if>
  ...
  <xsl:template name="formatPersonsAuthor">
    ...
    <xsl:if test="string-length(./b:Corporate)=0">
      <xsl:variable name="cP" select="count(./b:NameList/b:Person)"/>
      <xsl:for-each select="./b:NameList/b:Person">
        <xsl:choose>
          <xsl:when test="$cP &gt; 10">
          ...
          <xsl:otherwise>
            <xsl:call-template name="formatMainAuthor"/>
            <xsl:if test="position() &lt; $cP">
              <xsl:choose>
                <xsl:when test="$cP = 2">
                  <xsl:text> and </xsl:text>
                </xsl:when>
                <xsl:when test="position() = $cP - 1">
                  <xsl:text>, and </xsl:text>
                </xsl:when>
                <xsl:otherwise>
                  <xsl:text>, </xsl:text>
...
<xsl:if test="string-length(b:Author/*[local-name()=$name]/b:Corporate)=0">
      <xsl:variable name="cP" select="count(b:Author/*[local-name()=$name]/b:NameList/b:Person)"/>
...
<xsl:if test="string-length(b:Author/*[local-name()=$name]/b:Corporate)=0">
  ...
  <xsl:template name="secBy">
    <xsl:param name="role"/>
    <xsl:variable name="cP" select="count(b:Author/*[local-name()=$role]/b:NameList/b:Person)"/>
    <xsl:for-each select="b:Author/*[local-name()=$role]/b:NameList/b:Person">
      <xsl:call-template name="formatSecondaryName"/>
      <xsl:if test="position() &lt; $cP">
        <xsl:choose>
          <xsl:when test="$cP = 2">
    ...
    <xsl:if test="string-length(b:Author/*[local-name()=$role]/b:Corporate)>0">
      <xsl:value-of select="b:Author/*[local-name()=$role]/b:Corporate"/>
    </xsl:if>
  </xsl:template>
</xsl:stylesheet>
