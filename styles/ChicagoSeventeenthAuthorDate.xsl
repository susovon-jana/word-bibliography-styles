  ...
  <xsl:template match="/">
    ...
    <xsl:choose>
      ...
      <xsl:when test="b:OfficeStyleKey">
        <xsl:text>ChicagoAuthorDate17</xsl:text>
      </xsl:when>
      ...
      <xsl:when test="b:StyleNameLocalized">
        <xsl:choose>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1033'">
            <xsl:text>Chicago Author-Date 17th Edition</xsl:text>
          </xsl:when>
          <xsl:otherwise>
            <xsl:text>Chicago Author-Date 17th Edition</xsl:text>
          </xsl:otherwise>
                      ...
                      <xsl:when test="b:SourceType='Book'">
                        ...
                        <xsl:variable name="sg2">
                          ...
                          <xsl:if test="string-length($year)>0">
                            ...
                            <xsl:value-of select="$year"/><xsl:call-template name="need_Dot"><xsl:with-param name="field" select="$year"/></xsl:call-template>
                          </xsl:if>
                        </xsl:variable>
